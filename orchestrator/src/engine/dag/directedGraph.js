const { NodeDoesntExistError } = require("./errors");
...
module.exports = class DirectedGraph extends Graph {
     ...
     */
    addEdge(fromNodeIdentity, toNodeIdentity, skipUpdatingCyclicality = false) {
     ...
     */
    wouldAddingEdgeCreateCyle(fromNodeIdentity, toNodeIdentity) {
    ...
    getSubGraphStartingFrom(startNodeIdentity) {
        ...
        const recur = (startNodeIdentity, nodesToInclude) => {
        ...
        const newGraph = new DirectedGraph(this.nodeIdentity);
