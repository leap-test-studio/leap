...
const envVarsSchema = Joi.object()
  .keys({
    ...
    SMTP_FROM: Joi.string().description("SMTP from name").default("yuvarajsomavamshi@gmail.com"),
    ...
    SMTP_USER: Joi.string().description("SMTP server user name").default("yuvarajsomavamshi"),
