...
router.post("/importer/json", csrf, authorize(AuthRoles.Leads), projectImporter.single("upload-file"), importProject);
...
router.post("/:projectId/suite", csrf, authorize(AuthRoles.Leads), testSuiteSchema, createTestSuite);
router.post("/:projectId/suite/:suiteId/clone", csrf, authorize(AuthRoles.Leads), cloneTestSuite);
router.get("/:projectId/suite/:suiteId", csrf, authorize(AuthRoles.All), getTestSuite);
router.put("/:projectId/suite/:suiteId", csrf, authorize(AuthRoles.Leads), testSuiteSchema, updateTestSuite);
