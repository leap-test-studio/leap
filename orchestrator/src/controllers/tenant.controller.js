...
router.get("/", csrf, authorize(AuthRoles.Admins), listTenants);
router.post("/", csrf, authorize(Role.Admin), tenantSchema, createTenant);
router.get("/:tenantId", csrf, authorize(AuthRoles.All), getTenant);
router.put("/:tenantId", csrf, authorize(Role.Admin), tenantSchema, updateTenant);
router.delete("/:tenantId", csrf, authorize(Role.Admin), _deleteTenant);
