    ...
    <div className="flex flex-row w-full">
      <div className="w-[99%]">
        {modify ? (
          <textarea
            autoComplete="off"
            className="block caret-slate-300 h-10 text-xs rounded border placeholder-slate-500 shadow focus:shadow-md focus:border-color-0600 border-slate-300 focus:ring-color-0500 focus:outline-none w-full text-color-label"
