    ...
    <>
      <div className="relative bg-white rounded-md w-full h-full shadow-xl select-none">
        <div id="toast-success" className="p-2 flex items-center text-gray-500">
          ...
          <div className="ml-2 text-slate-700 font-semibold text-sm leading-5">CPU Usage</div>
        </div>
        ...
        {!isNaN(usage) ? (
          <div className="mt-2 mb-2">
            ...
            <div className="-mt-2">
              ...
              <div className="font-medium text-slate-500 text-sm text-center">{dayjs(Number(bootTime) * 1000).fromNow()}</div>
            </div>
          </div>
        ) : (
          <div className="flex flex-col items-center justify-center mt-4">
            <div className="bg-slate-200 animate-pulse h-20 w-20 rounded-full" />
            <div className="font-semibold text-slate-700 text-base text-center pb-1">Uptime</div>
