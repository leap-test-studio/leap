    ...
    <>
      {loading ? (
        ...
        <div className="bg-white h-fit shadow-lg w-96 rounded-md flex flex-col items-center p-5">
          ...
          <span id={`${id}-label`} className="my-4 text-center text-slate-800 uppercase text-2xl select-none">
            {title}
          </span>
          {details && <label className="my-2 text-center text-slate-700 text-lg select-none">{details}</label>}
